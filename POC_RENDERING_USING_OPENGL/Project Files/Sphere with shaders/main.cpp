...
//	glutCreateWindow("Molecule using shaders");
...
//		exit(1);
//	}
//	setShaders(prog_hdlr, "Project Files/Sphere with shaders/shaders/vert_shader.glsl", "Project Files/Sphere with shaders/shaders/frag_shader.glsl");
//
